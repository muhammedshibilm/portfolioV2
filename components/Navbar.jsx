...
export default function Navbar() {
    ...
    return (
        <nav className="text-beige sticky z-50  right-0">
            {/* above mobile  */}
            ...
            <div className={`w-full    flex      ${open ? "justify-around bg-darkBrown h-screen overflow-y-hidden fixed " : "justify-end relative"}  md:hidden`}>
                ...
                <div className={`icon p-2 rounded-lg hover:bg-oliveGreen space-y-2 cursor-pointer flex-2 relative w-fit h-fit top-5 right-5 ${open ? "bg-none" : "rounded-lg"}`}
